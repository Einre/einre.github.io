document.addEventListener("DOMContentLoaded", function () {
    ...
    // Call Open-Meteo API
    const apiUrl = `https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${long}&daily=temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max,rain_sum,showers_sum,snowfall_sum,precipitation_probability_max&temperature_unit=fahrenheit&wind_speed_unit=mph&precipitation_unit=inch&timezone=America%2FChicago`; 
    ...
    .then(data => {
        ...
        const tableBody = document.getElementById("weatherTable_lawrence");
